...
Examples:
User: "hello"
{"intent": "greeting", "sub_intents": [], "confidence": 99}

User: "I want to change my delivery address"
{"intent": "shipping_address_update", "sub_intents": [], "confidence": 95}

User: "cancel my moisturizer"
{"intent": "order_issue", "sub_intents": ["cancel_product"], "confidence": 90}

User: "my lotion arrived broken, I want to cancel it and can you suggest another one?"
{"intent": "order_issue", "sub_intents": ["cancel_product", "product_recommendation"], "confidence": 92}

User: "I want to talk to a human"
{"intent": "human_handoff", "sub_intents": [], "confidence": 100}
"""
    ...
    try:
        async with httpx.AsyncClient() as client:
            ...
            if not response_text:
                ...
                return ChatResponse(intent="unknown", sub_intents=[], confidence=0)
